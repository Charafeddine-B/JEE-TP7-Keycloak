package org.belyazid.customerfrontthymleafapp.sec;
...
public class SecurityConfig  {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(ar-> ar.requestMatchers("/","/oauth2Login/**","/webjars/**","/login","/h2-console/**","/products","auth").permitAll())
